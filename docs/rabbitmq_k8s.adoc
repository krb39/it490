...
`example-final/messaging-k8s.yml`.
...
[source, YAML]
----
include::../example-final/messaging-k8s.yml[tag=rbac]
----
...
[source, YAML]
----
include::../example-final/messaging-k8s.yml[tag=configmap]
----
...
[source, YAML]
----
include::../example-final/messaging-k8s.yml[tag=service]
----
...
[source, YAML]
----
include::../example-final/messaging-k8s.yml[tag=statefulset]
----
