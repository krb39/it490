...
Management System (DBMS), to the user.
...
.example-final/docker-compose.yml (excerpted)
[source, yml]
----
include::../example-final/docker-compose.yml[tags=db_services]
----
...
[source, Dockerfile]
----
include::../example-final/db/Dockerfile[]
----
...
.example-final/db/docker-entrypoint.sh (excerpted)
[source, bash]
----
include::../example-final/db/docker-entrypoint.sh[tags=find_primary]
----
...
[source, bash]
----
include::../example-final/db/docker-entrypoint.sh[tags=configure_primary]
----
...
[source, bash]
----
include::../example-final/db/docker-entrypoint.sh[tags=configure_standby]
----
...
[source, bash]
----
include::../example-final/db/docker-entrypoint.sh[tags=monitor]
----
